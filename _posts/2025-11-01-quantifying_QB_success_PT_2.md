...
<div class='tableauPlaceholder' id='viz1762029290305' style='position: relative'>
    <noscript>
        <a href='#'>
            <img alt='Side by Side Dashboard' src='https://public.tableau.com/static/images/QB/QBYearWeightsbyDecisionYear/SidebySideDashboard/1_rss.png' style='border: none' />
        </a>
    </noscript>
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='QBYearWeightsbyDecisionYear/SidebySideDashboard' />
        <param name='tabs' value='no' />
        <param name='toolbar' value='yes' />
        <param name='static_image' value='https://public.tableau.com/static/images/QB/QBYearWeightsbyDecisionYear/SidebySideDashboard/1.png' />
...
<script type='text/javascript'>
    var divElement = document.getElementById('viz1762029290305');
