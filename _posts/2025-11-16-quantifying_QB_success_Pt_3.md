...
# Article 3: Quarterback Trajectory Comparison Framework
## Career Path Trends & Strategic Analysis Basis
...
- **Growth differential:** Nearly 5x higher production growth for contract-earning QBs
...
**Josh Allen (2018, Pick 7) - The Gold Standard**
- Y1: 2,749 yards, 4.42 ANY/A
- Y2: 3,648 yards, 5.77 ANY/A (+1.35)
- **Y3: 5,019 yards, 7.88 ANY/A (+2.11)**
- Contract: Year 3
- Pattern: Steady improvement with Year 3 explosion

**Patrick Mahomes (2017, Pick 10) - Immediate Dominance**
- Y1: 300 yards, 6.14 ANY/A (backup)
- **Y2: 5,456 yards, 9.00 ANY/A (MVP)**
- Y3: 4,306 yards, 8.46 ANY/A
- Contract: Year 3
- Pattern: Instant elite status when given opportunity

**Joe Burrow (2020, Pick 1) - Consistency After Recovery**
- Y1: 2,861 yards, 5.77 ANY/A (injury)
- **Y2: 4,767 yards, 7.56 ANY/A**
- Y3: 4,757 yards, 6.79 ANY/A
- Contract: Year 3
- Pattern: High floor established immediately, peak in Year 2

**Deshaun Watson (2017, Pick 12) - Sustained Excellence**
- Y1: 2,005 yards, 7.29 ANY/A (limited games)
- Y2: 4,793 yards, 6.95 ANY/A
- Y3: 4,323 yards, 6.70 ANY/A
- **Y4: 5,324 yards, 8.29 ANY/A**
- Contract: Year 4
- Pattern: Always efficient, volume increased with experience
...
*Characteristic: Slow/limited start, dramatic Year 3+ emergence*
...
- Y1: 1,927 yards, 6.06 ANY/A (mid-season starter)
- **Y2: 4,392 yards, 8.27 ANY/A (MVP)**
- Y3: 3,803 yards, 6.75 ANY/A
- Y4: 3,678 yards, 5.81 ANY/A
- Pattern: Explosive Year 2 after limited Year 1

**Jared Goff (2016, Pick 1)**
- Y1: 1,444 yards, 2.87 ANY/A (7 starts)
- **Y2: 4,099 yards, 7.83 ANY/A**
- Y3: 4,962 yards, 7.78 ANY/A
- Pattern: Complete transformation from worst to elite

**Jordan Love (2020, Pick 26)**
- Y1: 442 yards, 4.54 ANY/A (backup)
- Y2: 195 yards, 10.28 ANY/A (backup, small sample)
- **Y3: 4,418 yards, 6.68 ANY/A (first full season)**
- Contract: Year 3
- Pattern: Immediate success when given opportunity

**Aaron Rodgers (2005, Pick 24)**
- Y1-2: Minimal playing time (backup to Favre)
- Y3: 259 yards, 7.14 ANY/A (spot duty)
- **Y4: 4,434 yards, 6.86 ANY/A (first full season)**
- Contract: Year 4
- Pattern: Learned behind elite QB, immediately productive
...
## III. COMPARISON FRAMEWORK FOR ARTICLE 4

### Section III: Trajectory Comparison Case Studies

**Recommended Structure:**

#### Case Study 1: Elite Early Developer vs. Current Prospects
**Comparable:** Josh Allen trajectory (2018-2021)
**Current Evaluation Target:** C.J. Stroud (2023 class)

| Metric | Josh Allen Y1-Y2 | C.J. Stroud Y1-Y2 | Variance |
|--------|------------------|-------------------|----------|
| Y1 ANY/A | 4.42 | 6.30 | +1.88 (Stroud ahead) |
| Y2 ANY/A | 5.77 | 5.44 | -0.33 (Allen ahead) |
| Y1 Yards | 2,749 | 4,135 | +1,386 (Stroud ahead) |
| Y2 Yards | 3,648 | 3,960 | +312 (Stroud ahead) |
| Y1-Y2 Growth | +1.35 ANY/A | -0.86 ANY/A | Divergent paths |

**Analysis Points:**
- Stroud's superior Year 1 vs. Allen's growth trajectory
- Allen's continuous improvement vs. Stroud's Year 2 regression
- Key question: Is Stroud's Year 2 dip a temporary adjustment or warning sign?
- Contract probability implications based on Year 3 projection

---

#### Case Study 2: Late Bloomer Pattern Recognition
**Comparable:** Jordan Love trajectory (2020-2023)
**Current Evaluation Targets:** Anthony Richardson, Trey Lance

| Player | Y1 Status | Y2 Status | Y3 Opportunity | Pattern Match |
|--------|-----------|-----------|----------------|---------------|
| Jordan Love | Backup (442 yds) | Backup (195 yds) | Starter: 4,418 yds, 6.68 ANY/A | Full pattern |
| Anthony Richardson | Limited (1,933 yds, 5.03 ANY/A) | Injured (2,313 yds, 4.74 ANY/A) | Y3 critical | Incomplete |
| Trey Lance | Very limited (741 yds, 4.80 ANY/A) | Backup/injured | Minimal opportunity | Failed opportunity |

**Analysis Points:**
- Love demonstrated immediate competence when given full control
- Richardson needs Year 3 health + volume to validate potential
- Lance's trajectory diverged due to lack of opportunity/fit

---

#### Case Study 3: Steady Improver Baseline
**Comparable:** Ryan Tannehill trajectory (2012-2015)
**Current Evaluation Targets:** Trevor Lawrence, Mac Jones

| Metric | Tannehill Path | Trevor Lawrence | Mac Jones |
|--------|----------------|-----------------|-----------|
| Y1 ANY/A | 5.36 | 4.57 | 5.96 |
| Y2 ANY/A | 5.11 | 6.69 | 4.81 |
| Y3 ANY/A | 5.95 | 5.99 | 5.02 |
| Y4 ANY/A | 6.02 | 5.99 | 4.97 |
| Contract | Year 4 | **Year 3 (PAID)** | Pending |

**Analysis Points:**
- Lawrence matched Tannehill's gradual improvement, earned early extension
- Jones regressed after strong rookie year (Early Peak archetype risk)
- Tannehill established 5.5+ ANY/A floor before extension

---

#### Case Study 4: Early Peak Risk Assessment
**Comparable:** Blake Bortles trajectory (2014-2018)
**Current Evaluation Targets:** Zach Wilson, Justin Fields

| Player | Y2 Performance | Y3+ Pattern | Contract Outcome |
|--------|----------------|-------------|------------------|
| Bortles | 4,855 yds, 6.20 ANY/A | Regression to 5.3-5.4 ANY/A | Extended Y4, cut Y5 |
| Zach Wilson | 1,800 yds, 4.99 ANY/A (limited) | Y3: 2,489 yds, 4.30 ANY/A | High risk |
| Justin Fields | 3,143 yds, 6.03 ANY/A | Y3-Y4: 5.86-5.74 ANY/A | Traded (no extension) |

**Analysis Points:**
- Bortles' Year 2 spike led to mistaken extension
- Wilson never achieved Year 2 competence (below Early Peak threshold)
- Fields showed steadier profile than Wilson but lacked elite ceiling

---

### Section IV: Current Market Analysis (2021-2024)

#### HIGH PROBABILITY COHORT (>70% contract probability)

**Tier 1A: Immediate Extension Candidates**

**C.J. Stroud** (2023, Pick 2) - 85% probability
...
**Jayden Daniels** (2024, Pick 2) - 78% probability (early projection)
...
**Bo Nix** (2024, Pick 12) - 72% probability (early projection)
...
#### MEDIUM PROBABILITY COHORT (30-70%)

**Tier 2A: Development Curve Incomplete**

**Anthony Richardson** (2023, Pick 4) - 55% probability
- Y1: 1,933 yards, 5.03 ANY/A (limited games)
- Y2: 2,313 yards, 4.74 ANY/A (injury shortened)
- Comparable: Lamar Jackson early trajectory (limited sample, rushing value)
- Archetype: Potential Late Bloomer
- Risk Factors: Injury concerns, limited sample size, efficiency decline
- Upside Scenario: Year 3 breakout (4,500+ yds, 6.5+ ANY/A) → 75% probability
- Downside Scenario: Continued injuries/inefficiency → 20% probability
- Projected Contract IF successful: Post-Y4 (2027), $45-50M AAV
- Key Inflection Point: Must play 15+ games in Year 3 with 6.0+ ANY/A

**Bryce Young** (2023, Pick 1) - 48% probability
...
**Justin Fields** (2021, Pick 11) - 42% probability (already traded)
...
**Caleb Williams** (2024, Pick 1) - 45% probability (very early)
...
**Tier 2B: Limited Opportunity / Development Stalled**

**Mac Jones** (2021, Pick 15) - 38% probability
...
**Trey Lance** (2021, Pick 3) - 12% probability
...
**Zach Wilson** (2021, Pick 2) - 8% probability
...
#### LOW PROBABILITY COHORT (<30%)

**Kenny Pickett** (2022, Pick 20) - 25% probability
- Y1: 2,525 yards, 5.38 ANY/A
- Y2: 2,280 yards, 5.57 ANY/A
- Y3: 306 yards, 5.50 ANY/A (traded mid-season)
- Analysis: Marginal starter profile, traded in Year 3
- Comparable: Teddy Bridgewater (adequate, not franchise-caliber)
- Archetype: Steady but insufficient - needed 6.0+ ANY/A by Year 2
...
### For Teams: Contract Timing Optimization
...
- Cost Savings: $5-8M AAV vs. waiting for Year 4 market
...
- Criteria: Below 5.8 ANY/A in Year 3, declining trajectory, major concerns
...
- **Current Candidates:** Mac Jones, Justin Fields (new team)
...
- **Current Candidates:** Zach Wilson, Kenny Pickett

---

### For Agents: Negotiation Timing Strategies

**Maximize Value Scenarios:**

**Early Extension (Post-Year 2):**
- Client Profile: Top 5 pick, elite Year 1-2 performance
- Precedent: Patrick Mahomes approach
- Strategy: Lock in before Year 3 market inflation
- Risk: Client foregoes potential Year 3 spike value
- **Current Opportunity:** Jayden Daniels (if Year 2 matches Year 1)

**Standard Timeline (Post-Year 3):**
- Client Profile: Established franchise QB, clear trajectory
- Precedent: Josh Allen, Joe Burrow
- Strategy: Demonstrate Year 3 consistency, negotiate early Year 4
- Risk: Minimal if performance maintained
- **Current Opportunity:** C.J. Stroud

**Delayed Extension (Year 4/5):**
- Client Profile: Late bloomer, inconsistent early career
- Precedent: Ryan Tannehill, Derek Carr
- Strategy: Play on fifth-year option, maximize contract year
- Risk: Injury or regression tanks value
- **Current Opportunity:** Anthony Richardson (needs health), Bryce Young (needs breakout)

---

### Performance Benchmark Targeting for Contract Maximization

**Position Client for Top-Tier Deal ($50M+ AAV):**
- Year 3: 6.8+ ANY/A, 4,500+ yards, playoff appearance
- Comparable: Josh Allen Year 3 (7.88 ANY/A) → $43M deal (2021)
- Market Adjusted (2025-27): $52-58M AAV

**Position Client for Mid-Tier Deal ($40-50M AAV):**
- Year 3: 6.3-6.7 ANY/A, 4,000+ yards, 9+ wins
- Comparable: Trevor Lawrence Year 3 (5.99 ANY/A) → $55M deal (2024)
- Note: Lawrence benefited from QB market inflation, not pure performance

**Position Client for Prove-It Extension ($30-40M AAV):**
- Year 3: 5.8-6.2 ANY/A, adequate volume, mixed results
- Comparable: Daniel Jones Year 4 (5.91 ANY/A) → $40M deal (2023)
- Risk: Team likely regrets deal if no further growth

---

### For Analysts: Market Inefficiency Identification

**Undervalued Profiles:**

1. **Late-Round Picks with Elite Early Developer Trajectory**
...
3. **Year 3 Regression Overreaction**
...
2. **High Volume, Low Efficiency Producers**
...
## VI. SUMMARY: KEY INSIGHTS FOR ARTICLE 4
...
2. **Growth Trajectory Matters More Than Draft Position**
   ...
   - **Conclusion:** Performance curve trumps draft capital
...
**Section I:** How We Overlaid Data
- Heatmap methodology from previous articles
- Trajectory plotting techniques
- Archetype classification system

**Section II:** Comp Generation Tool
- Reference QB_comp_tool.py methodology
- Similarity scoring algorithms
- Historical pattern matching

**Section III:** Case Study Analyses (Use Framework Above)
- Elite Developer: Allen → Stroud comparison
- Late Bloomer: Love → Richardson comparison
- Steady Improver: Tannehill → Lawrence comparison
- Early Peak Warning: Bortles → Fields/Jones comparison

**Section IV:** Current Market Analysis (Use Cohort Breakdowns Above)
- High Probability players with specific probabilities and projections
- Medium Probability players with inflection points identified
- Low Probability players with risk factors detailed

**Section V:** Strategic Applications (Use Frameworks Above)
- Team decision matrices
- Agent timing strategies
- Analyst inefficiency detection

---

This framework provides comprehensive basis for all comparison sections of Article 4, with specific player examples, statistical thresholds, and actionable insights for each stakeholder group.